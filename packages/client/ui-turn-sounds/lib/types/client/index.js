 ...
 */
import { loadSettings, playSound, primeAudioOnInteraction } from "./sounds.js";
import { SoundSettingsSection } from "./SoundSettingsSection.js";
...
export function apply(ctx) {
    ...
    const handleSnapshot = (sessionId, snapshot) => {
        ...
        const turns = knownTurns.get(sessionId) ?? new Set();
        const questions = knownQuestions.get(sessionId) ?? new Set();
