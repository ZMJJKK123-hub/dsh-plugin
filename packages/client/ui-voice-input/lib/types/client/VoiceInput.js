 ...
 */
export function VoiceInput({ useInput, inputActions, t }) {
    ...
    return (_jsx("button", { type: "button", className: `${css.trigger} ${listening ? css.listening : ''}`, "data-voice-input": true, "data-listening": listening || undefined, "data-error": error ?? undefined, "aria-label": listening ? t('trigger.stop') : t('trigger.start'), "aria-pressed": listening, title: error === null ? (listening ? t('trigger.stop') : t('trigger.start')) : t(`error.${error}`), onClick: () => { if (listening)
            stop();
        else
            start(); }, children: _jsx("svg", { viewBox: "0 0 16 16", className: css.icon, "aria-hidden": "true", children: _jsx("path", { d: "M8 1.5a2.25 2.25 0 0 0-2.25 2.25v4a2.25 2.25 0 0 0 4.5 0v-4A2.25 2.25 0 0 0 8 1.5Zm-3.5 6.25a3.5 3.5 0 0 0 7 0h-1a2.5 2.5 0 0 1-5 0h-1Zm4 4.4V14h2v1H5.5v-1h2v-1.85A4.75 4.75 0 0 1 3.25 7.5h1a3.75 3.75 0 0 0 7.5 0h1a4.75 4.75 0 0 1-4.25 4.65Z", fill: "currentColor" }) }) }));
}
