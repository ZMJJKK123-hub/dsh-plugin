...
export function saveBackground(url) {
...
export function isBackgroundApplied() {
 ...
 */
export async function encodeImage(file, maxWidth = DEFAULT_MAX_WIDTH, quality = DEFAULT_QUALITY) {
    ...
    if (context === null)
        throw new Error('background: canvas 2d context unavailable');
