        ...
        switch (key.ToLowerInvariant())
        {
            ...
            default:
                ...
                if (key.StartsWith("F", StringComparison.OrdinalIgnoreCase)
                    && int.TryParse(key.Substring(1), out int f)
 ...
 */
export function buildMouseTrajectoryCommand(options) {
 ...
 * @returns a PowerShell command string.
 */
export function buildMouseClickCommand(options) {
 ...
 * @returns a PowerShell command string.
 */
export function buildMouseScrollCommand(options) {
 ...
 * @returns a PowerShell command string.
 */
export function buildKeyboardCommand(options) {
